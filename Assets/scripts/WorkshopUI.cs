...
public class WorkshopUI : MonoBehaviour
{
    ...
    private void CreateOrSaveSkin()
    {
        ...
        SetStatus("Skin Saved Successfully!");
        UpdateButtons();
    }

    private void ApplyLocalization()
    {
        if (titleText != null) titleText.text = "Character Workshop";
        if (hintText != null) hintText.text = "Customize your character colors for the network dungeon";
        if (bodyAText != null) bodyAText.text = "Main Body";
        if (bodyBText != null) bodyBText.text = "Secondary";
        if (accentText != null) accentText.text = "Accent";
        UpdateButtons();
    }
    ...
    private void UpdateButtons()
    {
        if (createButtonText != null)
            createButtonText.text = "Save Character Skin";
    }
